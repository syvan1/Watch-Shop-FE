  ...
  return (
    <div className='w-container mx-auto mt-8'>
        ...
        <div>
          ...
          <div className='mt-6 space-y-4 text-gray-600'>
            <h1 className='flex items-center text-lg'>
              <img
                src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlDPs9wDho8XWvXOT05AR_87wxmKYv1XfTCnN4XY9Zgw&s'
                alt='oclock'
      ...
      <div className='bg-white p-8 rounded-lg shadow-lg mt-4 mb-5'>
        {/* sản phẩm tương tự*/}
        <h1 className='text-3xl font-semibold mb-4'>Similar food</h1>
