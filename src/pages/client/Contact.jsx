  ...
  return (
    <div>
        ...
        <div className='w-1/2 p-4 bg-slate-100 rounded-lg mr-3'>
          ...
          <div className='mb-4 flex items-center'>
            <p className='text-gray-700 flex'>
              ...
              <div className='mt-3 ml-3'>
                <span className='text-main-black font-bold'>Address:</span> Đường Bắc Kan, TP Thái Nguyên
              </div>
            </p>
          </div>
          <div className='flex items-center'>
            <p className='text-gray-700 flex'>
              ...
              <div className='mt-3 ml-3'>
                <span className='text-main-black font-bold'>Email: </span>Sago1049@gmail.com
              </div>
            </p>
          </div>
        </div>
      ...
      <div className='w-container mx-auto mb-8 h-[500px]'>
        <iframe
          src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7420.1807842979115!2d105.81171982615204!3d21.582394444001597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31352738b1bf08a3%3A0x515f4860ede9e108!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiB2w6AgVHJ1eeG7gW4gdGjDtG5n!5e0!3m2!1sen!2s!4v1713033766487!5m2!1sen!2s'
          width={1300}
          height={500}
          style={{ border: 0 }}
          allowFullScreen
